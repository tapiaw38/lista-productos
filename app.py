...
class Product:
    ...
    def __init__(self, window):
        # Initializations
        self.wind = window
        self.wind.title('Productos Application')
    ...
    def add_product(self):
        if self.validation():
            ...
            self.message['text'] = 'Producto {} guardado correctamente'.format(self.name.get())
            self.name.delete(0, END)
            self.price.delete(0, END)
        else:
            self.message['text'] = 'Nombre y Precio son Requiridos'
        self.get_products()
    ...
    def delete_product(self):
        ...
        self.message['text'] = 'Registro {} borrado correctamente'.format(name)
        self.get_products()
    ...
    def edit_records(self, new_name, name, new_price, old_price):
        ...
        self.message['text'] = 'Registro {} modificado correctamente'.format(name)
        self.get_products()
